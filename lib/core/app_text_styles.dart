...
class AppTextStyles {
  static final TextStyle titlePrimary = GoogleFonts.notoSans(
  ...
  static final TextStyle heading30White = GoogleFonts.notoSans(
    color: AppColors.white,
    fontSize: 30,
    fontWeight: FontWeight.w600,
  );

  static final TextStyle heading30Primary = GoogleFonts.notoSans(
    color: AppColors.primary,
    fontSize: 30,
    fontWeight: FontWeight.w600,
  );
